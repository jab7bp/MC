...
double I_beam_uA = lookup_beam_current( kine, run_target );
...
void simc_dxdy(){
	...
	rootfile_dir = Form( "/lustre19/expphy/volatile/halla/sbs/jboyd/simulation/out_dir/MC_REPLAY_OUT_DIR/simc/SBS%i", kine );
